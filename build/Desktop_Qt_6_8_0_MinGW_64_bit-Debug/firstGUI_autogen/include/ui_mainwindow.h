...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget1 = new QWidget(tab_10);
        widget1->setObjectName("widget1");
        widget1->setGeometry(QRect(120, 170, 311, 94));
